...
parent.className = 'users-box'
for (const user of usersList) {
    let child = document.createElement('div');
    child.className = 'user-block'
    let info = document.createElement('h2');
    info.innerText = `${user.id} - ${user.name} - ${user.username}`;
    let contact = document.createElement('h3');
    contact.innerText = `${user.email} - ${user.phone}`;
    ...
    address.append(city, street, suite, zipCode);
    child.append(info, contact, address);
